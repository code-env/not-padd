...
import {
  ...
  SheetHeader,
  SheetTitle,
} from "@notpadd/ui/components/sheet";
    ...
    >
      ...
      >
        <div
          ...
          className="bg-sidebar group-data-[variant=floating]: flex h-full w-full flex-col group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:"
        >
          {children}
        </div>
      </div>
